...
const getCheckoutData = async ()=>{
    ...
    console.log(res);
    curAddress.value = res.data.result.userAddresses.find(item=>item.isDefault === 0)
    checkInfo.value = res.data.result
}
onMounted(()=> getCheckoutData())
  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      <div class="wrapper">
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button @click="postCheckoutInfo" type="primary" size="large" >提交订单</el-button>
        </div>
      </div>
    </div>
  </div>
...
<el-dialog title="切换收货地址"  v-model="showDialog" width="30%" center>
  <div class="addressWrapper">
    <div class="text item" v-for="item in checkInfo.userAddresses" :class="{active:activeAddress.id === item.id}" :key="item.id" @click="switchAddress(item)">
      <ul>
