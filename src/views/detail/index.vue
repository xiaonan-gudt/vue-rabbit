...
import ImageView from '@/components/imagesView.vue/index.vue'
    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${detailData.categories?.[0].parent.id}` }">{{detailData.categories?.[0].parent.name}}
          </el-breadcrumb-item>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                <img v-for="item in detailData.details?.pictures" :key="item" :src="item" alt="">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
